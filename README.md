...
- **QR export**: one tap shows a full-screen QR code; scan it with your phone and the game opens in Lichess's import form; tick "Request a computer analysis" before importing to get every inaccuracy, mistake and blunder marked.
